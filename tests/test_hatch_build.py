...
def test_metadata_hook_update_uses_commit_hash(
    ...
    assert metadata["readme"] == {
        ...
        "text": "[Docs](https://github.com/arm/mlia-converters-pytorch/blob/"
        "0123456789abcdef/docs.md)\n"
        "![Image](https://raw.githubusercontent.com/arm/mlia-converters-pytorch/"
        "0123456789abcdef/image.png)\n"
        "[Section](https://github.com/arm/mlia-converters-pytorch/blob/"
...
def test_metadata_hook_update_falls_back_to_version_or_hash(
    ...
    assert metadata["readme"] == {
        "content-type": "text/markdown",
        "text": f"[Docs](https://github.com/arm/mlia-converters-pytorch/blob/{revision}/docs.md)",
    }
